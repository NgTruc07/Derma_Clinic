    ...
    public partial class QuanLyThuoc : Form
    {
        ...
        private void LoadThuoc()
        {
           DataClasses2DataContext db = new DataClasses2DataContext();
            ...
            dgvThuoc.Columns["MaThuoc"].Width = 150; // Độ rộng cột MaThuoc
            dgvThuoc.Columns["TenThuoc"].Width = 250; // Độ rộng cột TenThuoc
            dgvThuoc.Columns["DonViTinh"].Width = 100; // Độ rộng cột DonViTinh
            dgvThuoc.Columns["MoTa"].Width = 500; // Độ rộng cột MoTa
